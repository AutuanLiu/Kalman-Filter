...
if flag == 1
    % 含有噪音
    title('Longlag Linear Signals with noise');
    saveas(gcf, '../images/longlag_linear_signals_info_noise1.png');
    save('longlag_linear_signals5D_noise1.mat', 'longlag_linear_signals');
else
    % 不含噪音
    title('Longlag Linear Signals without noise');
    saveas(gcf, '../images/linear_signals_info_noise0.png');
    save('longlag_linear_signals5D_noise0.mat', 'longlag_linear_signals');
end

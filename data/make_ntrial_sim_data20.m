...
for trial=1:ntrial
    ...
    x11(1:max_lag, 1) = init(:, 1) + noise(1:max_lag , 1);
    x12(1:max_lag, 1) = init(:, 2) + noise(1:max_lag , 2);
    x13(1:max_lag, 1) = init(:, 3) + noise(1:max_lag , 3);
    x14(1:max_lag, 1) = init(:, 4) + noise(1:max_lag , 4);
    x15(1:max_lag, 1) = init(:, 5) + noise(1:max_lag , 5);
    x16(1:max_lag, 1) = init(:, 5) + noise(1:max_lag , 5);
    x17(1:max_lag, 1) = init(:, 5) + noise(1:max_lag , 5);
    x18(1:max_lag, 1) = init(:, 5) + noise(1:max_lag , 5);
    x19(1:max_lag, 1) = init(:, 5) + noise(1:max_lag , 5);
    x20(1:max_lag, 1) = init(:, 5) + noise(1:max_lag , 5);
    ...
    for t=(max_lag + 1):nlen  % 信号时域
        ...
        x11(t) = 0.95*sqrt(2) * x1(t-1) - 0.9025 * x1(t-2) + noise(t, 11);
        x12(t) = 0.5 * x1(t-2) + noise(t, 12);
        x13(t) = 0.9 * x2(t-3) + noise(t, 13);
        x14(t) = -0.5 * x11(t-2) + noise(t, 14);
        x15(t) = 0.8 * x4(t-4) - 0.4 * x19(t-2) + noise(t, 15);
        x16(t) = -0.8 * x4(t-4) + noise(t, 16);
        x17(t) = 0.4 * x1(t-1) - 0.4 * x1(t-2) + noise(t, 17);
        x18(t) = -0.9 * x7(t-2) + 0.4 * x18(t - 3) + 0.3 * x19(t - 3) + noise(t, 18);
        x19(t) = -0.3 * x8(t-3) + 0.4 * x9(t-3)+ noise(t, 19);
        x20(t) = -0.75* x17(t-4) + noise(t, 20);
    end
    ...
    for t=(max_lag + 1):nlen  % 信号时域
        ...
        x5(t) = 0.8 * x4(t-4) - 0.4 * x9(t-2) + noise(t, 5);
        x6(t) = -0.8 * x4(t-4) + noise(t, 6);
        x7(t) = 0.4 * x1(t-1) * x1(t-1) - 0.4 * x1(t-2) + noise(t, 7);
        x8(t) = -0.9 * x7(t-2) + 0.4 * x8(t - 3) + 0.3 * x9(t - 3) + noise(t, 8);
        x9(t) = -0.3 * x8(t-3) + 0.4 * x9(t-3)+ noise(t, 9);
        x10(t) = -0.75* x7(t-4) + noise(t, 10);

        x11(t) = 0.95*sqrt(2) * x1(t-1) - 0.9025 * x1(t-2) + noise(t, 11);
        x12(t) = 0.5 * x1(t-2) * x1(t-2) + noise(t, 12);
        x13(t) = 0.9 * x2(t-3) + noise(t, 13);
        x14(t) = -0.5 * x11(t-2) + noise(t, 14);
        x15(t) = 0.8 * x4(t-4) - 0.4 * x19(t-2) + noise(t, 15);
        x16(t) = -0.8 * x4(t-4) + noise(t, 16);
        x17(t) = 0.4 * x1(t-1) * x1(t-1) - 0.4 * x1(t-2) + noise(t, 17);
        x18(t) = -0.9 * x7(t-2) + 0.4 * x18(t - 3) + 0.3 * x19(t - 3) + noise(t, 18);
        x19(t) = -0.3 * x8(t-3) + 0.4 * x9(t-3)+ noise(t, 19);
        x20(t) = -0.75* x17(t-4) + noise(t, 20);
    end
    ...
    for t=(max_lag + 1):nlen  % 信号时域
        ...
        x10(t) = -0.75* x7(t-4) + noise(t, 10);
        x11(t) = 0.95*sqrt(2) * x1(t-1) - 0.9025 * x1(t-2) + noise(t, 11);
        x12(t) = 0.5 * x1(t-10) + noise(t, 12);
        x13(t) = 0.9 * x2(t-3) + noise(t, 13);
        x14(t) = -0.5 * x11(t-2) + noise(t, 14);
        x15(t) = 0.8 * x4(t-4) - 0.4 * x19(t-2) + noise(t, 15);
        x16(t) = -0.8 * x4(t-4) + noise(t, 16);
        x17(t) = 0.4 * x1(t-10) - 0.4 * x1(t-2) + noise(t, 17);
        x18(t) = -0.9 * x7(t-2) + 0.4 * x18(t - 3) + 0.3 * x19(t - 3) + noise(t, 18);
        x19(t) = -0.3 * x8(t-3) + 0.4 * x9(t-3)+ noise(t, 19);
        x20(t) = -0.75* x17(t-4) + noise(t, 20);
    end
    ...
    for t=(max_lag + 1):nlen  % 信号时域
        ...
        x11(t) = 0.95*sqrt(2) * x1(t-1) - 0.9025 * x1(t-2) + noise(t, 11);
        x12(t) = 0.5 * x1(t-10) * x1(t-10) + noise(t, 12);
        x13(t) = 0.9 * x2(t-3) + noise(t, 13);
        x14(t) = -0.5 * x11(t-2) + noise(t, 14);
        x15(t) = 0.8 * x4(t-4) - 0.4 * x19(t-2) + noise(t, 15);
        x16(t) = -0.8 * x4(t-4) + noise(t, 16);
        x17(t) = 0.4 * x1(t-10) * x1(t-10) - 0.4 * x1(t-2) + noise(t, 17);
        x18(t) = -0.9 * x7(t-2) + 0.4 * x18(t - 3) + 0.3 * x19(t - 3) + noise(t, 18);
        x19(t) = -0.3 * x8(t-3) + 0.4 * x9(t-3)+ noise(t, 19);
        x20(t) = -0.75* x17(t-4) + noise(t, 20);
    end
...
% 保存信号数据
save('linear_signals20D_noise100.mat', 'linear_signals100');
save('nonlinear_signals20D_noise100.mat', 'nonlinear_signals100');
save('longlag_linear_signals20D_noise100.mat', 'longlag_linear_signals100');
save('longlag_nonlinear_signals20D_noise100.mat', 'longlag_nonlinear_signals100');

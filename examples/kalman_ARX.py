...
file_path = './data/longlag_linear_signals5D_noise1.mat'
data = get_mat_data(file_path, 'longlag_linear_signals')
...
est_model = make_linear_func(A_coef, var_name='x', fname='./data/longlag_linear_est_model.txt')
print(est_model)
...
est_model = make_func4K4FROLS(y_coef, candidate_terms, Kalman_S_No, fname='./data/longlag_linear_Kalmal4FROLS_est_model.txt')
print(est_model)
...
est_model = make_func4K4FROLS(y_coef, candidate_terms, Kalman_S_No, fname='./data/longlag_linear_torch4FROLS_est_model.txt')
print(est_model)
